...
class ViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let imageBounds = CGRect(x: pageBounds.midX - signatureImage.size.width/2, y: pageBounds.midY - signatureImage.size.height/2, width: signatureImage.size.width, height: signatureImage.size.height)
    ...
    func setupPdfView() {
        ...
        if let documentURL = URL(string: "https://cubebox.secube.com.tr/Download/PdfFormlar/HEPONLINE3a.pdf"),
